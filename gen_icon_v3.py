...
PROMPT = 'A cute chibi white kitten sitting next to a small wooden Gomoku board, traditional Chinese ink wash painting style with visible brush strokes, flat color illustration, kawaii cute style, big round eyes, simple clean lines, red collar with golden bell, black and white stones on the board, background of misty Chinese ink mountains and clouds, bamboo and pine trees silhouette, warm golden sunrise glow, rice paper texture, minimal detail, adorable cartoon cat, storybook illustration, centered composition'
NEG = 'realistic photo, 3d render, hyper detailed, complex shading, dark, scary, ugly, text, watermark, photorealistic fur, busy cluttered'
...
WF = {
    ...
    '253': {'class_type': 'KSampler', 'inputs': {
        ...
        'latent_image': ['252', 0], 'seed': 99,
        'steps': 4, 'cfg': 1.0,
        'sampler_name': 'euler', 'scheduler': 'simple', 'denoise': 1.0}},
    '254': {'class_type': 'VAEDecode', 'inputs': {'samples': ['253', 0], 'vae': ['246', 0]}},
    '255': {'class_type': 'SaveImage', 'inputs': {'images': ['254', 0], 'filename_prefix': 'app_icon_v3'}},
}

print('Submitting app icon v3...')
    ...
    for nid, out in entry.get('outputs', {}).items():
        for item in out.get('images', []):
            ...
            if fname.endswith('.png'):
                ...
                dst = os.path.join(SAVE_DIR, 'app_icon_v3.png')
